      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="d-none d-md-inline">Mỹ Linn</span>
          </a>
          <div class="dropdown-menu " style="width: 160px;">
            <a href="#" class="dropdown-item" data-toggle="modal" data-target="#modal-lg">Tài khoản</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" tabindex="-1" href="dangxuat">Đăng xuất</a>
          </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 position-fixed">
      ...
      <a href="./index3.html" class="brand-link">
        <img src="./dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
        <span class="brand-text font-weight-light">Violette</span>
      </a>
      ...
      <div class="sidebar ">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="custom-user-menu.html" class="nav-link active">
            ...
            <li class="nav-item">
              <a href="DanhMuc.html" class="nav-link ">
            ...
            <li class="nav-item">
              <a href="PhieuNhap.html" class="nav-link ">
            ...
            <li class="nav-item">
              <a href="NhaCungCap.html" class="nav-link ">
