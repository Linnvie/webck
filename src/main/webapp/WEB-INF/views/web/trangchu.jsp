...
<div class="hero_area">
  ...
  <section class="suggest_section">
    ...
    <div class="container text-center">
      <h1 class="mb-5"><strong>BEST SELLER</strong></h1>
      <div class="row">
        <div class="col-md-3 d-flex flex-column">
          ...
          <div class="p-4" style="background-color:#FBEDE2; font-size: 20px;">Flowers <span><i class="bi bi-arrow-right"></i></span></div>
        </div>
        <div class="col-md-3 d-flex flex-column">
          <div class="img_container">
          ...
          <div class="p-4" style="background-color:#FBEDE2; font-size: 20px;">Occasions <span><i class="bi bi-arrow-right"></i></span></div>
        </div>
        <div class="col-md-3 d-flex flex-column">
          <div class="img_container">
          ...
          <div class="p-4" style="background-color:#FBEDE2; font-size: 20px;">Collections <span><i class="bi bi-arrow-right"></i></span></div>
        </div>
        <div class="col-md-3 d-flex flex-column">
          <div class="img_container">
      ...
      <a href="#" class="d-inline-block mt-5" style="color:#86A48E; border: solid #86A48E 2px; padding: 17px 30px; border-radius: 30px; width: 180px;">VIEW MORE</a>
    </div>
  </section>
  <!-- end section suggest -->
  ...
  <section class="category_section position-relative">
    <div class="our_prod py-3 px-5 h3 d-flex flex-row" style="transform:rotate(-90deg);"><strong>OUR PRODUCTS</strong><div style="width:200px; height:2px; background-color: black; margin-top:15px; margin-left:8px;"></div></div>
    <div class="container mb-5">
      <div class="row">
        <div class="col-md-4 d-flex flex-column">
          <div class="img_container">
            <img src="https://i.pinimg.com/564x/ca/3a/0f/ca3a0f2f3b30e8e162b4bc9b5009b6c8.jpg"  style="object-fit:cover; width: 100%; max-height: 100%;">
          </div>
          <div class="p-4" style="background-color:#FBEDE2; font-size: 20px;">Flowers <span><i class="bi bi-arrow-right"></i></span></div>
        </div>
        <div class="col-md-4 d-flex flex-column">
          <div class="img_container">
            <img src="https://i.pinimg.com/564x/31/e3/5c/31e35c73aba225fa58bc862d9a97c682.jpg"  style="object-fit:cover; width: 100%; max-height: 100%;">
          </div>
          <div class="p-4" style="background-color:#FBEDE2; font-size: 20px;">Occasions <span><i class="bi bi-arrow-right"></i></span></div>
        </div>
        <div class="col-md-4 d-flex flex-column">
          <div class="img_container">
            <img src="https://i.pinimg.com/564x/96/13/24/961324d8eaea0907ca627585f5a5bfd8.jpg"  style="object-fit:cover; width: 100%; max-height: 100%;">
          </div>
          <div class="p-4" style="background-color:#FBEDE2; font-size: 20px;">Collections <span><i class="bi bi-arrow-right"></i></span></div>
        </div>
      </div>
